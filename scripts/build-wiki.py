...
<style>
  ...
  .wk-main a.wl {{ color: var(--text); border-bottom: 1px dashed rgba(217,68,43,0.5); }}
  .wk-main a.wl:hover {{ color: var(--accent); text-decoration: none; }}
  .wk-main pre {{ font-family: var(--mono); font-size: 12.8px; line-height: 1.7;
             background: #0B0B0D; border: 0.5px solid var(--border); border-radius: 11px;
             padding: 15px 17px; color: #D8D2C4; overflow-x: auto; margin: 14px 0 18px;
             max-width: 730px; }}
