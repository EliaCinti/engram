#!/usr/bin/env bash
#
# with-venv.sh — esegue un comando dentro il venv locale di engram,
...
#
# Esempi:
#   scripts/with-venv.sh python -c "from engram.store import MemoryStore as M; print(M().brain_dir)"
#   scripts/with-venv.sh python engram/server.py        # avvio manuale del server
